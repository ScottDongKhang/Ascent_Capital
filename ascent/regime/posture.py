...
_POSTURE_MAP = {
    "calm_bull": {
        ...
        "notes":           "Trend intact. Full exposure appropriate. Favour momentum and quality.",
    },
    "euphoric": {
        "posture":         "selective",
        "risk_multiplier": 0.85,
        "notes":           "Late-cycle signals. Avoid crowded momentum; trim concentration.",
    },
    "stressed": {
        "posture":         "defensive",
        "risk_multiplier": 0.65,
        "notes":           "Risk elevated. Reduce concentration; prefer low-vol and quality tilt.",
    },
    "crisis": {
        "posture":         "crisis",
...
if __name__ == "__main__":
    test_cases = [
        ("stressed", {"calm_bull": 0.12, "euphoric": 0.08, "stressed": 0.64, "crisis": 0.16}, 6),
        ("calm_bull", {"calm_bull": 0.82, "stressed": 0.18}, 42),
        ("crisis",   {"crisis": 0.51, "stressed": 0.49}, 2),
        ("calm_bull", {"calm_bull": 0.55, "stressed": 0.45}, 1),   # low confidence -> uncertain
    ]
    for label, probs, days in test_cases:
        r = compute_posture_from_regime("2026-03-13", label, probs, days)
        print(f"{label:12s}  conf={r.confidence:.2f}  posture={r.posture:14s}  mult={r.risk_multiplier}  days={r.days_in_regime}")
