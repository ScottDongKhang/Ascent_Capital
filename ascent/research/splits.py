"""
Ascent Capital — Walk-Forward Splits
Time-aware train/test splits for leakage-free evaluation.

The split generator yields (train_start, train_end, test_start, test_end) date tuples.
A purge gap between train and test prevents label leakage when targets are multi-day.
"""
