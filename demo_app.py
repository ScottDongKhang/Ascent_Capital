...
BASE_SLEEVES = {
    "Trend": 0.55, "Stat-Arb": 0.15, "Mean Rev": 0.05, "ML (XGBoost)": 0.10,
    "Vol-Regime": 0.05, "Fundamental": 0.05, "Earnings": 0.05,
}

# Regime-aware sleeve adjustments (trend-heavy in stress, ML/fundamental reduced)
SLEEVE_ADJUSTMENTS = {
    "calm_bull": {"Trend": 0.00,  "Stat-Arb": 0.00,  "Mean Rev": 0.00,  "ML (XGBoost)": 0.00,  "Vol-Regime": 0.00,  "Fundamental": 0.00,  "Earnings": 0.00},
    "stressed":  {"Trend": +0.08, "Stat-Arb": -0.03, "Mean Rev": +0.02, "ML (XGBoost)": -0.07, "Vol-Regime": +0.03, "Fundamental": -0.02, "Earnings": -0.01},
    "crisis":    {"Trend": +0.12, "Stat-Arb": -0.05, "Mean Rev": +0.03, "ML (XGBoost)": -0.08, "Vol-Regime": +0.05, "Fundamental": -0.04, "Earnings": -0.03},
    "uncertain": {"Trend": +0.05, "Stat-Arb": -0.02, "Mean Rev": 0.00,  "ML (XGBoost)": -0.03, "Vol-Regime": +0.02, "Fundamental": -0.01, "Earnings": -0.01},
}

PORTFOLIO_PRESETS = {
    "Current Ascent (Apr 15)": {
        "EWY": 0.108, "PDBC": 0.093, "CASY": 0.060, "CAT": 0.060,
        "EQIX": 0.060, "MPWR": 0.060, "TRGP": 0.060, "HYG": 0.048,
        "BIL": 0.047, "DBB": 0.046, "EWZ": 0.045, "EWT": 0.045,
        "NEM": 0.044, "LQD": 0.035, "MRK": 0.033, "IFRA": 0.030,
        "VNQ": 0.029, "PAVE": 0.027, "AMZN": 0.025, "GOOGL": 0.023,
        "CB": 0.019, "EWC": 0.006,
    },
    "Tech-Heavy": {
